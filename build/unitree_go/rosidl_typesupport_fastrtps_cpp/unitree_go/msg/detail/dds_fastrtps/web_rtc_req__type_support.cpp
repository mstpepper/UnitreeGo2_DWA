...
#include "unitree_go/msg/detail/web_rtc_req__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const unitree_go::msg::WebRtcReq & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unitree_go::msg::WebRtcReq & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_go::msg::WebRtcReq;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_go::msg::WebRtcReq *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_go::msg::WebRtcReq *>(
    untyped_ros_message);
...
{
  return &unitree_go::msg::typesupport_fastrtps_cpp::_WebRtcReq__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_go, msg, WebRtcReq)() {
  return &unitree_go::msg::typesupport_fastrtps_cpp::_WebRtcReq__handle;
}
