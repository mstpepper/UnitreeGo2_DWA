...
#define NODE_MAIN_LOGGER_NAME "bag_to_image_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbag_to_image.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<BagToImage>";
