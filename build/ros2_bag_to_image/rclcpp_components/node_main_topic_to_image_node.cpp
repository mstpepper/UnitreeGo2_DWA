...
#define NODE_MAIN_LOGGER_NAME "topic_to_image_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtopic_to_image.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TopicToImage>";
